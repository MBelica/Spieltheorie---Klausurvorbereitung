...
\end{figure}
	...
	\item Wieviele verschiedene Strategien haben hier die Spielerinnen 2 und 3? (4P)
		\begin{proof}
			Spielerin 2 hat vier Strategien. Sie hat zwei Möglichkeiten falls $L$ gespielt wird und zwei falls $R$ gespielt wird. Achte drauf, dass eine Strategie ein vollständiger Handlungsplan ist, d.h. die Strategien sind
